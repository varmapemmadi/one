...
<head>
    ...
    <title>DevOps Engineers Portfolio WEB</title>
    <style>
        /* General Styles */
        body {
...
<body>
    <header>
        <h1>VARMA - DevOps with springboot JAVA</h1>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm VARMA FROM HYD, a DevOps Engineer passionate about optimizing workflows and delivering scalable, automated solutions. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
    ...
    <section id="projects" class="projects">
        <h2>Projects</h2>
        <div class="project">
            <h3>Bank Application Deployment with AZURE</h3>
    ...
    <footer>
        <p>© 2024 Varma | DevOps Engineer Portfolio | <a href="#about">Back to Top</a></p>
    </footer>
</body>
</html>
